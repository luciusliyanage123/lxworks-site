  ...
  return (
    <>
      ...
      <section className="section pt-12 pb-20">
        <h1 className="h2">Café Concierge — Orders & Loyalty</h1>
        <p className="p mt-3 max-w-2xl">A café assistant that handles DMs, orders, and loyalty lookups. Local inference via Ollama and encrypted SQLite for customer memory.</p>
