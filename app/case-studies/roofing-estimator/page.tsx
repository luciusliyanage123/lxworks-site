  ...
  return (
    <>
      ...
      <section className="section pt-12 pb-20">
        <h1 className="h2">Roofing Estimator — Quotes in Minutes</h1>
        <p className="p mt-3 max-w-2xl">Estimator that parses PDF specs, generates bill of materials, and issues draft quotes. Fine-tuned on historical estimates.</p>
